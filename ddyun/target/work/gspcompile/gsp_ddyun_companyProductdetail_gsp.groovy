...
class gsp_ddyun_companyProductdetail_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyProduct/detail.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
expressionOut.print(product.logo)
printHtmlPart(7)
...
public static final long LAST_MODIFIED = 1465976599725L
