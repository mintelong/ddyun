...
class gsp_ddyun_companyaboutus_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/aboutus.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
expressionOut.print(cc.companyTitle)
printHtmlPart(12)
expressionOut.print(cc.logo)
printHtmlPart(13)
expressionOut.print(cc.companyCultureContent)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1465976600706L
