...
class gsp_ddyun_companycompanycase_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/companycase.gsp" }
public Object run() {
Writer out = getOut()
...
for( c in (clist) ) {
printHtmlPart(15)
expressionOut.print(c.url)
printHtmlPart(16)
expressionOut.print(c.logo)
printHtmlPart(17)
}
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1466094238310L
