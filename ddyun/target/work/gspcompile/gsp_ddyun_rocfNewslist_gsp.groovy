...
class gsp_ddyun_rocfNewslist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/rocfNews/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',57,['controller':("rocfNews"),'action':("create")],2)
printHtmlPart(7)
...
printHtmlPart(11)
invokeTag('formatDate','g',77,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(12)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',78,['controller':("rocfNews"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1465976600839L
