...
class gsp_ddyun_loginregister_gsp extends GroovyPage {
...
printHtmlPart(4)
expressionOut.print(resource(dir: 'css', file: 'user.css'))
printHtmlPart(5)
})
...
createTagBody(1, {->
printHtmlPart(7)
expressionOut.print(resource(dir:'images',file:'rock.png'))
printHtmlPart(8)
expressionOut.print(resource(dir:'images/temp',file:'0.jpg'))
printHtmlPart(9)
expressionOut.print(resource(dir:'images',file:'loginB.jpg'))
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1465976600990L
