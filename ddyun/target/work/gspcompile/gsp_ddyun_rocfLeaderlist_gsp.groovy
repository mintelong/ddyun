...
class gsp_ddyun_rocfLeaderlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/rocfLeader/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',57,['controller':("rocfLeader"),'action':("create")],2)
printHtmlPart(7)
...
printHtmlPart(12)
invokeTag('formatDate','g',83,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(10)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',84,['controller':("rocfLeader"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1465976598612L
