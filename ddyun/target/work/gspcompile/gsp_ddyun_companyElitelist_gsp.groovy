...
class gsp_ddyun_companyElitelist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyElite/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',54,['controller':("companyElite"),'action':("create")],2)
printHtmlPart(7)
for( company in (lists) ) {
printHtmlPart(8)
expressionOut.print(company.name)
printHtmlPart(9)
expressionOut.print(company.englishName)
printHtmlPart(10)
expressionOut.print(company.title)
printHtmlPart(10)
expressionOut.print(company.shortResume)
printHtmlPart(10)
expressionOut.print(company.longResume)
printHtmlPart(11)
expressionOut.print(company.logo)
printHtmlPart(12)
invokeTag('formatDate','g',80,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(10)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',81,['controller':("companyElite"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1466046096160L
