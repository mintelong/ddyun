...
class gsp_ddyun_companyCulturelist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyCulture/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',55,['controller':("companyCulture"),'action':("create")],2)
printHtmlPart(7)
for( company in (lists) ) {
printHtmlPart(8)
expressionOut.print(company.companyName)
printHtmlPart(9)
expressionOut.print(company.type)
printHtmlPart(9)
expressionOut.print(company.companyTitle)
printHtmlPart(10)
expressionOut.print(company.companyCultureContent)
printHtmlPart(11)
expressionOut.print(company.logo)
printHtmlPart(12)
invokeTag('formatDate','g',79,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(10)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',80,['controller':("companyCulture"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1466090238982L
