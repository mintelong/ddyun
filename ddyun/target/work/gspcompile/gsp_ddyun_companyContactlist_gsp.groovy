...
class gsp_ddyun_companyContactlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyContact/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',54,['controller':("companyContact"),'action':("create")],2)
printHtmlPart(7)
for( company in (lists) ) {
printHtmlPart(8)
expressionOut.print(company.tel)
printHtmlPart(9)
expressionOut.print(company.address)
printHtmlPart(10)
expressionOut.print(company.officer)
printHtmlPart(10)
...
invokeTag('link','g',77,['controller':("companyContact"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(12)
}
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1466046578587L
