...
class gsp_ddyun_companywork_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/work.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
expressionOut.print(resource(dir:'images/temp',file:'case3.png'))
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1465976600302L
