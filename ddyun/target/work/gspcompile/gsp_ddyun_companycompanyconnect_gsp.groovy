...
class gsp_ddyun_companycompanyconnect_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/companyconnect.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
expressionOut.print(cc.tel)
printHtmlPart(12)
expressionOut.print(cc.address)
printHtmlPart(13)
expressionOut.print(cc.officer)
printHtmlPart(14)
expressionOut.print(cc.email)
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1465976597974L
