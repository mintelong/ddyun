...
class gsp_ddyun_rocfCulturelist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/rocfCulture/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',57,['controller':("rocfCulture"),'action':("create")],2)
printHtmlPart(7)
for( company in (lists) ) {
printHtmlPart(8)
expressionOut.print(company.title)
printHtmlPart(9)
expressionOut.print(company.content)
printHtmlPart(10)
invokeTag('formatDate','g',75,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(10)
createClosureForHtmlPart(11, 3)
invokeTag('link','g',76,['controller':("rocfCulture"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(12)
}
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1465976599517L
