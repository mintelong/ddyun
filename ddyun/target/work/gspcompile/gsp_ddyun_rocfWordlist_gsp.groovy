...
class gsp_ddyun_rocfWordlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/rocfWord/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',57,['controller':("rocfWord"),'action':("create")],2)
printHtmlPart(7)
...
invokeTag('link','g',77,['controller':("rocfWord"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(12)
}
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1465976600714L
