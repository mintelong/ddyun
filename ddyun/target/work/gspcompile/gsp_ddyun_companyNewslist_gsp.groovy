...
class gsp_ddyun_companyNewslist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyNews/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',53,['controller':("companyNews"),'action':("create")],2)
printHtmlPart(7)
...
printHtmlPart(11)
invokeTag('formatDate','g',73,['date':(company.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(12)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',74,['controller':("companyNews"),'action':("delete"),'params':([id:"${company.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1466046305121L
