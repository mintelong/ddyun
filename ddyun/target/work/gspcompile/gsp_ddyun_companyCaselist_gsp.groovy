...
class gsp_ddyun_companyCaselist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyCase/list.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',54,['controller':("companyCase"),'action':("create")],2)
printHtmlPart(7)
for( companyCase in (lists) ) {
printHtmlPart(8)
expressionOut.print(companyCase.name)
printHtmlPart(9)
expressionOut.print(companyCase.description)
printHtmlPart(10)
expressionOut.print(companyCase.logo)
printHtmlPart(11)
invokeTag('formatDate','g',74,['date':(companyCase.date),'format':("yyyy-MM-dd HH:mm:ss")],-1)
printHtmlPart(12)
createClosureForHtmlPart(13, 3)
invokeTag('link','g',75,['controller':("companyCase"),'action':("delete"),'params':([id:"${companyCase.id}"])],3)
printHtmlPart(14)
}
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1466089945458L
