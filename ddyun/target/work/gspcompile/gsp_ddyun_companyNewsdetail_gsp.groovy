...
class gsp_ddyun_companyNewsdetail_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/companyNews/detail.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(4)
expressionOut.print(news.logo)
printHtmlPart(5)
expressionOut.print(news.content)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1465979377639L
