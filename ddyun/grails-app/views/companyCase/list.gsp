...
<div class="RocfCul_box">
    ...
    <div class="col-md-3">
        ...
        <div class="RocfCul_list">
        	<dl>
                ...
                <dd class="on"><a href="/ddyun/companyCase/list">案例展示</a></dd>
                <dd><a href="/ddyun/companyCulture/list">企业认证</a></dd>
    ...
    <div class="col-md-9">
    	<div class="CopCul_cont">
        	<div class="line2">
            	<g:link controller="companyCase" action="create"><span>添加合作案例</span></g:link>
            </div>
