    ...
    <div class="col-md-3">
        ...
        <div class="CopCul_list">
        	<dl>
                ...
                <dd class="on"><a href="/ddyun/company/pcase">合作案例</a></dd>
            	...
            	<ul>
                    ...
                    <li>
                        <div class="ComCase_cont">
                        	...
                        	<img src="${resource(dir:'images',file:'专精特新领军企业.jpg')}">
                        	</a>
                        </div>
                    </li>
                    <!--循环li 最多12个多的分页 结束-->
                    ...
                    <li>
                        <div class="ComCase_cont">
                        	<img src="${resource(dir:'images',file:'上海博物馆藏国之魂宝牺尊.jpg')}">
                        </div>
                    </li>
                    <li>
                        <div class="ComCase_cont">
                        	<img src="${resource(dir:'images',file:'温馨塘桥宜居生活.jpg')}">
                        </div>
                    </li>
