<%@ page import="com.ddyun.company.CompanyNews" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="col-	md-3">
        ...
        <div class="Coplaw_list">
        	<dl>
                ...
                <dd><a href="/ddyun/company/newscenter">国内企业</a></dd>
                <dd class="on"><a href="/ddyun/company/filtercomapnynews?type=金融"><i></i>金融</a></dd>
                <dd><a href="/ddyun/company/filtercomapnynews?type=法律"><i></i>法律</a></dd>
                <dd><a href="/ddyun/company/filtercomapnynews?type=IT"><i></i>IT</a></dd>
                <dd><a href="/ddyun/company/filtercomapnynews?type=健康"><i></i>健康</a></dd>
                <dd><a href="/ddyun/company/filtercomapnynews?type=教育"><i></i>教育</a></dd>
                <dd><a href="/ddyun/company/filtercomapnynews?type=旅游"><i></i>旅游</a></dd>
            </dl>
        </div>
        <!--企业文化列表 结束-->
...
.CoplawT_text p{line-height:24px;color:#949494;height:70px;overflow:hidden;}
            ...
            <!--详情1 结束-->
              <div class="Elite_page">
                ...
                <ul>
                	<li><a href="/ddyun/company/newscenter">首页</a></li>
                    <!--上一页 开始-->
                    <li><a href="/ddyun/company/newscenter"><</a></li>
                    <!--上一页 结束-->
                    
                    <!--页数 开始-->
                    <li class="on"><a href="/ddyun/company/newscenter">1</a></li>
                    <li><a href="/ddyun/company/newscenter2">2</a></li>
                    <!--页数 结束-->
                    
                    <!--下一页 开始-->
                    <li><a href="/ddyun/company/newscenter2">></a></li>
                    <!--下一页 结束-->
                    <li><a href="/ddyun/company/newscenter2">末页</a></li>
                </ul>
            </div>
...
function search(){
	var type = $("#type").val()
	window.location.href="/ddyun/company/filtercomapnynews?type="+type;
}
</script>
</body>
</html>