...
<div class="RocfCul_box">
    ...
    <div class="col-md-3">
        ...
        <div class="RocfCul_list">
        	<dl>
	               ...
	               <dd class="on"><a href="/ddyun/rocfCulture/list">侨联文化</a></dd>
    ...
    <div class="col-md-9">
    	<div class="CopCul_cont">
        	<div class="line2">
            	<g:link controller="rocfCulture" action="create"><span>添加</span></g:link>
            </div>
                    ...
                    <tbody>
                    	...
                    	<g:each in="${lists}" var="company">
                    		<tr>
	                            ...
	                            <td><g:link controller="rocfCulture" action="delete" params='[id:"${company.id}"]'>删除</g:link></td>
                        	</tr>
                    	</g:each>
