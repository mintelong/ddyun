...
<div class="RocfCul_box">
    ...
    <div class="col-md-9">
    	<div class="CopCul_cont">
            ...
            <g:form url="[resource:wordsInstance, action:'add']" >
            <div class="Perpaw_cont">
            	<ul>
                	<li>
                        <span><i class="Required"></i>留言主题：<input name="title" id="title" value="" /></span>
                    </li>
                    <li>
                        <span><i class="Required"></i>留言内容：
                       		  <input name="words" id="words" value="" />
                        </span>
                    </li>
                    <li><g:submitButton name="add" class="btn btn-primary radius4" value="保存" /></li>                   
                </ul>
            </div>
            </g:form>
        </div>
