		    	...
		    	<div class="CopCul_cont">
		            ...
		            <g:uploadForm id="companyForm" url="[action:'save']" >
			            <div class="PerRel_cont">
			            	<ul>
			                	<li>
			                        <span><i class="Required">*</i>电话：
			                        	<input type="text" name="tel" id="tel" value="">
			                        </span>
			                    </li>
			                    <li>
			                        <span><i class="Required">*</i>地址：
			                        	<input type="text" name="address" id="address" value="">
			                        </span>
			                    </li>
			                    <li>
			                        <span><i class="Required">*</i>负责人：
			                        	<input type="text" name="officer" id="officer" value="">
			                        </span>        
			                    </li>
			                    <li>
			                        <span><i class="Required">*</i>邮箱：
